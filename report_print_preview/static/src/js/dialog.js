...
// #################################################################################
odoo.define("report_print_preview.PreviewDialog", function (require) {
"use strict";
...
var pdfPreview = core.Class.extend({
    ...
    preview: function( url ) {
        ...
        var urlTempalte = _.template("/report_print_preview/static/lib/PDFjs/web/viewer.html?file=<%= url %>");
